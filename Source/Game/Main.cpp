...
INT WINAPI wWinMain(_In_ HINSTANCE hInstance, _In_opt_ HINSTANCE hPrevInstance, _In_ LPWSTR lpCmdLine, _In_ INT nCmdShow)
{
    ...
    std::shared_ptr<AdditionalCube> additionalCube = std::make_shared<AdditionalCube>("squaretile.dds");
   
    if (FAILED(game->GetRenderer()->AddRenderable(L"AdditionalCube", additionalCube)))
    {
        return 0;
    }
