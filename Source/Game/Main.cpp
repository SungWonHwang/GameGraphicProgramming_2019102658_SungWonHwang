...
INT WINAPI wWinMain(_In_ HINSTANCE hInstance, _In_opt_ HINSTANCE hPrevInstance, _In_ LPWSTR lpCmdLine, _In_ INT nCmdShow)
{
    ...
    std::shared_ptr<library::Model> nanomodel = std::make_shared<library::Model>("nanosuit/nanosuit.obj");

    if (FAILED(game->GetRenderer()->AddRenderable(L"Nanosuit", nanomodel)))
    {
        return 0;
    }
